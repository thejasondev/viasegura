...
export const signals: TrafficSignal[] = [
  // Prohibitivas / Reglamentarias
  { id: 'sp-00', name: 'CEDA EL PASO', category: 'prohibitiva', description: 'Reducir velocidad y ceder el paso', meaning: 'Indica la obligación de ceder el paso a los vehículos que circulan por la vía a la que se aproxima.', shape: 'triangle', colors: ['red', 'white'], svgIcon: 'ceda' },
  { id: 'sp-01', name: 'PARE', category: 'prohibitiva', description: 'Detenerse completamente antes de la línea', meaning: 'El conductor debe detener completamente el vehículo antes de la línea de pare y ceder el paso.', shape: 'octagon', colors: ['red', 'white'], svgIcon: 'pare' },
  { id: 'sp-02', name: 'No Estacionar', category: 'prohibitiva', description: 'Prohibido detenerse o aparcar', meaning: 'No se permite estacionar ni detenerse en esta zona.', shape: 'circle', colors: ['red', 'white', 'blue'], svgIcon: 'prohibido_estacionar' },
  { id: 'sp-03', name: 'No Adelantar', category: 'prohibitiva', description: 'Prohibido rebasar al vehículo precedente', meaning: 'Está prohibido adelantar en esta zona. Mantenga su carril.', shape: 'circle', colors: ['red', 'white'], svgIcon: 'prohibido_adelantar' },
  { id: 'sp-04', name: 'No Girar a la Izquierda', category: 'prohibitiva', description: 'Prohibido girar a la izquierda', meaning: 'El giro a la izquierda está prohibido en esta intersección.', shape: 'circle', colors: ['red', 'white'], svgIcon: 'no_girar_izquierda' },
  { id: 'sp-05', name: 'No Girar a la Derecha', category: 'prohibitiva', description: 'Prohibido girar a la derecha', meaning: 'El giro a la derecha está prohibido en esta intersección.', shape: 'circle', colors: ['red', 'white'], svgIcon: 'no_girar_derecha' },
  { id: 'sp-06', name: 'No Entrar', category: 'prohibitiva', description: 'Prohibido circular en esa dirección', meaning: 'Vía de un sentido. No puede entrar por esta dirección.', shape: 'circle', colors: ['red', 'white'], svgIcon: 'no_entrar' },
  { id: 'sp-07', name: 'Velocidad Máxima 50', category: 'prohibitiva', description: 'No exceder 50 km/h', meaning: 'La velocidad máxima permitida en esta zona es de 50 km/h.', shape: 'circle', colors: ['red', 'white'], svgIcon: 'velocidad_50' },
  { id: 'sp-08', name: 'Velocidad Máxima 30', category: 'prohibitiva', description: 'No exceder 30 km/h', meaning: 'Zona de velocidad reducida. Máximo 30 km/h (zona escolar u hospital).', shape: 'circle', colors: ['red', 'white'], svgIcon: 'velocidad_30' },
  { id: 'sp-09', name: 'No Sonar Bocina', category: 'prohibitiva', description: 'Prohibido usar la bocina', meaning: 'El uso de la bocina está prohibido en esta zona (hospital, residencial).', shape: 'circle', colors: ['red', 'white'], svgIcon: 'no_sonar_bocina' },
  { id: 'sp-10', name: 'No Peatones', category: 'prohibitiva', description: 'Prohibido tránsito de peatones', meaning: 'Los peatones no pueden transitar por esta vía (autopista).', shape: 'circle', colors: ['red', 'white'], svgIcon: 'no_peatones' },
  { id: 'sp-11', name: 'No Bicicletas', category: 'prohibitiva', description: 'Prohibido tránsito de bicicletas', meaning: 'Las bicicletas no pueden circular por esta vía.', shape: 'circle', colors: ['red', 'white'], svgIcon: 'no_bicicletas' },
  { id: 'sp-12', name: 'No Dar Vuelta en U', category: 'prohibitiva', description: 'Prohibido dar vuelta en U', meaning: 'No se permite invertir el sentido de la marcha en este punto.', shape: 'circle', colors: ['red', 'white'], svgIcon: 'no_vuelta_u' },
  ...
  { id: 'so-04', name: 'Rotonda', category: 'obligatoria', description: 'Circulación obligatoria en rotonda', meaning: 'Indica entrada a rotonda. Ceda el paso y circule en sentido contrario a las manecillas del reloj.', shape: 'circle', colors: ['blue', 'white'], svgIcon: 'rotonda' },
  ...
  // Preventivas
  { id: 'sv-01', name: 'Curva Peligrosa Derecha', category: 'preventiva', description: 'Curva cerrada a la derecha', meaning: 'Precaución, curva peligrosa a la derecha. Reduzca velocidad.', shape: 'diamond', colors: ['yellow', 'black'], svgIcon: 'curva_peligrosa' },
  ...
  { id: 'sv-04', name: 'Paso Peatonal', category: 'preventiva', description: 'Zona de cruce de peatones', meaning: 'Paso de peatones adelante. Reduzca velocidad y ceda el paso.', shape: 'diamond', colors: ['yellow', 'black'], svgIcon: 'peatones' },
  { id: 'sv-05', name: 'Zona Escolar', category: 'preventiva', description: 'Proximidad de escuela', meaning: 'Zona escolar adelante. Velocidad máxima 30 km/h. Extreme precaución.', shape: 'diamond', colors: ['yellow', 'black'], svgIcon: 'escolares' },
